...
?CND8:	SET	'PERFORMING-SPELL,FALSE-VALUE
	ZERO?	P-CONT /?ELS18
	SET	'PTR,P-CONT
...
?ELS95:	CALL	WT?,WRD,PS?PREPOSITION,0 >VAL
	ZERO?	VAL \?THN100
	EQUAL?	WRD,W?ALL,W?ONE,W?BOTH /?THN104
...
?ELS48:	EQUAL?	VERB,ACT?FIND \?ELS52
	...
	CRLF	
	RFALSE	
?ELS52:	EQUAL?	WINNER,PROTAGONIST /?ELS56
	CALL	CANT-ORPHAN
	RSTACK	
...
?CND1:	SET	'P-GWIMBIT,GBIT
	...
	PRINTI	" of"
?CND19:	FSET?	OBJ,NARTICLEBIT /?ELS26
	PRINTI	" the "
	JUMP	?CND16
?ELS26:	PRINTI	" "
?CND16:	PRINTD	OBJ
...
?PRG25:	ZERO?	GCHECK /?ELS29
	...
	JUMP	?CND27
?ELS29:	ZERO?	LIT \?THN36
	ZERO?	BLORTED /?CND33
?THN36:	FCLEAR	PLAYER,TRANSBIT
...
?CND33:	CALL	DO-SL,PLAYER,SH,SC
	...
	ZERO?	P-ADJ /?ELS43
	EQUAL?	P-NAM,W?SPELL,FALSE-VALUE \?ELS43
	CALL	SPELL-CHECK,TBL,P-ADJN
	JUMP	?CND38
?ELS43:	CALL	SPELL-CHECK,TBL,P-NAM
?CND38:	
?CND27:	GET	TBL,P-MATCHLEN
	SUB	STACK,TLEN >LEN
	BTST	P-GETFLAGS,P-ALL \?ELS50
	JUMP	?CND48
?ELS50:	BTST	P-GETFLAGS,P-ONE \?ELS52
	ZERO?	LEN /?ELS52
	EQUAL?	LEN,1 /?CND55
	RANDOM	LEN
	GET	TBL,STACK
	...
	PRINTI	"?)"
	CRLF	
?CND55:	PUT	TBL,P-MATCHLEN,1
	JUMP	?CND48
?ELS52:	GRTR?	LEN,1 /?THN64
	ZERO?	LEN \?CND48
	EQUAL?	P-SLOCBITS,-1 /?CND48
?THN64:	EQUAL?	P-SLOCBITS,-1 \?ELS70
	...
	JUMP	?PRG25
?ELS70:	ZERO?	LEN \?CND73
	SET	'LEN,OLEN
?CND73:	EQUAL?	WINNER,PROTAGONIST /?ELS78
	CALL	CANT-ORPHAN
	RFALSE	
?ELS78:	ZERO?	VRB /?ELS82
	ZERO?	P-NAM /?ELS82
...
?CND85:	SET	'P-ACLAUSE,STACK
	...
	JUMP	?CND76
?ELS82:	ZERO?	VRB /?CND76
	PRINT	NOUN-MISSING
	CRLF	
?CND76:	SET	'P-NAM,FALSE-VALUE
	SET	'P-ADJ,FALSE-VALUE
	RFALSE	
?CND48:	ZERO?	LEN \?ELS99
	ZERO?	GCHECK /?ELS99
	ZERO?	VRB /?CND102
	ZERO?	LIT \?THN109
	ZERO?	BLORTED \?THN109
	EQUAL?	PRSA,V?WHAT,V?WHERE,V?TELL /?THN109
	EQUAL?	PRSA,V?FROTZ,V?WHO \?ELS108
...
?ELS5:	CALL	SEARCH-LIST,FOO,TBL,P-SRCALL
	NEXT?	FOO >FOO /?KLU12
?KLU12:	JUMP	?PRG1
?REP2:	CALL	DO-SL,LOCAL-GLOBALS,1,1
...
?CND17:	EQUAL?	OBJ,HANDS \?ELS27
	JUMP	?PRG10
?ELS27:	EQUAL?	PRSA,V?TAKE-OFF \?ELS29
	LOC	PROTAGONIST
	EQUAL?	OBJ,STACK \?ELS29
	JUMP	?PRG10
?ELS29:	EQUAL?	WINNER,PROTAGONIST /?ELS33
	JUMP	?PRG10
?ELS33:	CALL	HELD?,OBJ
	ZERO?	STACK \?PRG10
	SET	'PRSO,OBJ
	FSET?	OBJ,TRYTAKEBIT \?ELS38
	SET	'TAKEN,TRUE-VALUE
	JUMP	?CND36
?ELS38:	EQUAL?	WINNER,PROTAGONIST /?ELS40
	SET	'TAKEN,FALSE-VALUE
	JUMP	?CND36
?ELS40:	BTST	IBITS,STAKE \?ELS42
	CALL	ITAKE,FALSE-VALUE
	EQUAL?	STACK,TRUE-VALUE \?ELS42
	SET	'TAKEN,FALSE-VALUE
	JUMP	?CND36
?ELS42:	SET	'TAKEN,TRUE-VALUE
?CND36:	ZERO?	TAKEN /?ELS49
	BTST	IBITS,SHAVE \?ELS49
	PRINT	YNH
	GET	TBL,P-MATCHLEN
	LESS?	1,STACK \?ELS56
	PRINTI	"all those things"
	JUMP	?CND54
?ELS56:	EQUAL?	OBJ,NOT-HERE-OBJECT \?ELS60
	PRINTI	" that"
	JUMP	?CND54
?ELS60:	CALL	ARTICLE,OBJ,TRUE-VALUE
	CALL	THIS-IS-IT,OBJ
?CND54:	PRINTI	"!"
	CRLF	
	RFALSE	
?ELS49:	ZERO?	TAKEN \?PRG10
